...
description: "Words? Words are hard. The only thing harder than words is taking them seriously. Let's talk about content, product and what needs to change"
date: 2021-04-12
themes: ["craft"]
source: Blossom
...
Having a dedicated attention span to focus on words can streamline interfaces, reduce support costs and increase customer satisfaction, but we still staff content teams like agencies. Many teams will work through a problem and wait until the end to "polish the words." This is forcing content to fit form, and it's where many product teams are. To quote [Jeffery Zeldman](https://twitter.com/zeldman): “Design in the absence of content is not design, it’s decoration.”

## What we're doing next

Words are hard. The only thing harder than getting words right is putting off getting your words right. Humans have an inverse relationship to hard things, we like to avoid them. So agile software development teaches us to do hard things early and often [to reduce the pain](https://martinfowler.com/bliki/FrequencyReducesDifficulty.html).
...
- 18F is [doing something similar](https://handbook.tts.gsa.gov/writing-lab/) with their Writing Lab.
...
- Shopify has witten about [their approach](https://ux.shopify.com/how-we-structure-our-content-strategy-team-2e00ea4301a2) to content design in product and gotten to a 1:1 ratio on many but not all projects.
- Stanley Wood’s [“Design Doesn’t Scale”](https://medium.com/@hellostanley/design-doesnt-scale-4d81e12cbc3e#.eymzl6281) which has lots of great stuff on how design works at Spotify
- The Book [Org Design for Design Orgs](https://www.amazon.com/Org-Design-Orgs-Building-House/dp/1491938404)  which focuses on how to build design teams
- [Jonathan Colman](https://noti.st/jcolman/jO6Ndh/plenary-session-how-to-maximize-the-impact-of-content-design) has written a lot on the matter and given several talks. This one stands out for talking about how to maximise the impact of content design as a discipline. There's also this whole talk about [how to hire a world class content team](https://noti.st/jcolman/cv1Wq3#sCai32J) for hiring managers.
