...
description: "In 2020, 8.4 million people of working age (16-64) reported that they were disabled; this is 20% of Britain's working age population. Hire disabled people"
date: 2021-04-22
themes: ["ethics"]
source: Blossom
...
A friend asked me for support connecting with someone who could help them into employment in the UK. So I tweeted [asking for help](https://twitter.com/Intentionaut/status/1378079548823207937?s=20) from the internet. I got a few retweets and some good responses, but damn it's hard to find good leads if you don't have the emotional energy to chase the leads.
...
[Findings show](https://pubmed.ncbi.nlm.nih.gov/29392591/#:~:text=Findings%20show%20that%20benefits%20of,customers%2C%20customer%20loyalty%20and%20satisfaction%2C) hiring people with disabilities include improvements in profitability, competitive advantage, and inclusive work culture.
...
You cannot understand people you never listen to, this is true of product strategy, user research, and building inclusive workplaces. [Carly Findlay](https://twitter.com/carlyfindlay) has written a book on growing up disabled in Australia. Make room for disabled people to share their experiences in their own words.

Disability is complicated and there's no one right answer to how to help. Even [disabled people disagree](https://www.forbes.com/sites/andrewpulrang/2021/02/13/4-important-things-disabled-people-disagree-about/?sh=689dc24c6f22) with each other from time to time about how they want to drive change and improvement.

### 2. Fight disability stigma at work

Stigma is still deeply entrenched in the workplace as a whole. We can do more to make the workplace safer. Work with experts like [The Ability People](https://www.theabilitypeople.com/) (TAP) to change your workplace culture. You should also [be aware of what discrimination at work looks like](https://www.mind.org.uk/information-support/legal-rights/discrimination-at-work/examples-of-discrimination-at-work/), and specifically [disability discrimination](https://www.citizensadvice.org.uk/law-and-courts/discrimination/discrimination-because-of-disability/what-counts-as-disability-discrimination/).

Mark Esho is a disabled entrepreneur and he shared some really great thoughts on [how employers can change](https://ablemagazine.co.uk/able-talks-to-disabled-entrepreneur-mark-esho-on-supporting-disabled-people-in-work/) their workplace practices around disability. Stigma looks different in different workplaces, and everyone can do more to ensure it's safe to have a disability at work.

### 3. Don't just fight stigma, take action

[Stigma fighting alone](https://themighty.com/2020/01/fighting-mental-health-stigma-political-advocacy/) cannot change the number of people with disabilities who have sustainable employment or the right level of legal and governmental support to maintain their quality of life. [Work with disabled](https://blog.google/inside-google/life-at-google/autistic-googler-and-his-manager-thrive-through-communication/) people at work to build healthy mechanisms for feedback and improvement.
...
- [Big Ambitions](http://www.bigambitions.org.uk/services/) is a community interest company established in 2010 who deliver support programmes to help people to gain and retain work alongside and improve poor  mental health
- Gov.uk has a scheme called [Intensive Personalised Employment Support](https://www.gov.uk/intensive-personalised-employment-support) focused on helping unemployed disabled people access support
- [Action on Disability](https://aod.org.uk/employment-services/) provides a range of services, but you have to contact them for additional support
