...
description: "As a design leader, it is your responsibility to design the outcomes and work conditions for your team to succeed"
date: 2021-04-07
...
A common problem with interviewing is that it's subject to opinion, and especally first impressions. A study [conducted at the University of Toledo](https://www.researchgate.net/publication/313878823_The_importance_of_first_impressions_in_a_job_interview) in 2000 found that judgments made in the first 10 seconds of an interview could predict the outcome of the interview. Culture fit is [a failed idea](https://www.huffpost.com/entry/culture-fit-failed-idea-in-hiring_l_5f1f2319c5b69fd47310363e) in American hiring, and it's losing steam.

Interviews run like the one in the study are built on a form of bias called [confirmation bias](https://www.psychologytoday.com/us/blog/science-choice/201504/what-is-confirmation-bias). We make snap judgments all day, every single day.

In Thinking Fast and Slow, Daniel Kahneman [wrote](https://www.goodreads.com/book/show/11468377-thinking-fast-and-slow) "we can be blind to the obvious, and we are also blind to our blindness." Many of our interview techniques are inherited and can be based on these forms of blindness.

Gut evaluations of candidate performance are only one part of the problem. Teams using incomplete or ambiguous values can also run into confirmation bias problems, by structuring their hiring process around the notion of culture fit. [Previously](https://www.mindtheproduct.com/2019/06/how-culture-add-changes-the-conversation-on-hiring/), I've written about how culture add can change the conversation on hiring. It can also change the mindset of hiring panels and train them to gather evidence for how candidates can bring talent into the organisation.
...
Hiring is hard. Bias is already everywhere, because humans have bias in hiring and other daily tasks at work. Structure [helps us eliminate bias](https://www.shrm.org/resourcesandtools/hr-topics/talent-acquisition/pages/ditch-the-beer-test-and-start-hiring-for-culture-add.aspx).

### Increase the number of perspectives

A simple way to reduce bias is to increase the diversity of perspectives in hiring. Intel uses diversity panels to reduce [unconscious bias](https://www.mya.com/blog/unconscious-bias-in-job-descriptions/). Their hiring panel is required to have 2 women and underrepresented minorities for every candidate.
...
Structured interviews are a form of interviewing in which candidates are asked the same questions and evaluated on the same criteria across all the interviews. Doing this can eliminate bias and help weigh candidates on more equal measures across interviews. Don't take my word for it, here's a bigger piece [from Forbes](https://hbr.org/2016/04/how-to-take-the-bias-out-of-interviews) on the same subject.

Structured interviews are [twice as likely](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.2044-8325.1988.tb00467.x) to predict good performance on the job compared to unstructured ones. Not only that, unstructured interviews are a very poor predictor of job performance. In fact, when it comes to assessing someone's performance in the future based on unstructured questions, these interviews are [less valuable than random selection](http://journal.sjdm.org/12/121130a/jdm121130a.pdf).
