...
description: "Many companies think about developer velocity and story points, but never focus on decision velocity"
date: 2023-03-29
...
Decision velocity is one of the key measures of a successful business culture. In fact, [McKinsey](https://www.mckinsey.com/capabilities/people-and-organizational-performance/our-insights/untangling-your-organizations-decision-making?ref=blossomat.work), [Bain](https://www.bain.com/insights/decision-insights-7-create-a-decision-focused-culture/?ref=blossomat.work) and even Jeff Bezos have focused on it quite a bit. Jeff Bezos spent much of Amazon's annual shareholder letter talking about decision making in 2016. He [wrote](https://www.aboutamazon.com/news/company-news/2016-letter-to-shareholders?ref=blossomat.work) that "Most decisions should probably be made with somewhere around 70% of the information you wish you had. If you wait for 90%, in most cases, you’re probably being slow."
...
[Marty Cagan](https://www.svpg.com/four-big-risks/?ref=blossomat.work) defines these as The Four Risks: Value, Usability, Viability, and then Business Feasibility. These risks and their impact should be obvious and referred to often when making decisions.
...
Lay out a simple process to go from input/idea to decisions to outcomes. Define major *decision* milestones up front. I've seen many times people want to define time-based milestones, but what's often more important early in a product lifecycle is . In the [double diamond method](https://www.designcouncil.org.uk/our-work/skills-learning/tools-frameworks/framework-for-innovation-design-councils-evolved-double-diamond/?ref=blossomat.work) of discovery, it's fairly easy to gather important stakeholders and set expectations on their input at the same time. Keep it simple.
