...
In [2012](https://www.forbes.com/sites/kashmirhill/2012/02/16/how-target-figured-out-a-teen-girl-was-pregnant-before-her-father-did/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last), Target could [predict pregnancy](https://www.predictiveanalyticsworld.com/machinelearningtimes/how-target-gets-the-most-out-of-its-guest-data-to-improve-marketing-roi/6815/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) before customers announced it to their families—a textbook example of first-party data creating competitive advantages. Today, those same capabilities are available through APIs.

For a while, proprietary datasets created obvious advantages—Target’s pregnancy predictions became a case study.

But a decade later, even highly specialised datasets can be leapfrogged by general-purpose AI. Bloomberg trained a [50-billion parameter model](https://www.bloomberg.com/company/press/bloomberggpt-50-billion-parameter-llm-tuned-finance/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) on 363 billion tokens from four decades of curated financial data, plus 345 billion tokens from general datasets. Despite this massive proprietary advantage, GPT-4 without specialised finance training [beat BloombergGPT](https://mypeasesoria.org/blog/bloomberggpt--fine-tuning---moat-building?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) on almost all finance tasks. Bloomberg's 2023 launch of BloombergGPT reveals how quickly proprietary advantages erode.

The performance gap between leading AI models has compressed dramatically, as [industry analysis](https://sloanreview.mit.edu/article/five-trends-in-ai-and-data-science-for-2025/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) documents. When sophisticated capabilities become this accessible this quickly, where we think of strategic value starts to shift fundamentally.
...
Big data taught us that more isn’t always better. Companies [hoarded information](https://link.springer.com/article/10.1007/s40595-013-0001-6?utm_source=chatgpt.com), but without the [right culture or strategy,](https://www.mckinsey.com/industries/metals-and-mining/our-insights/adopting-a-smart-data-mindset-in-a-world-of-big-data/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) data lakes quickly turned into swamps. We’re seeing the same pattern with AI: stockpiles of proprietary data aren’t enough when a competitor with an API key to a modern LLM can generate comparable—or even superior—insights.
...
The market is projected to hit [$7.3 billion by 2029](https://superagi.com/2025-trends-in-ai-recommendation-engines-how-ai-is-revolutionizing-product-discovery-across-industries/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last#:~:text=The%20Current%20State%20of%20AI%20Recommendation%20Technology,-The%20current%20state&text=The%20global%20recommendation%20engine%20market%20is%20projected%20to%20reach%20around,USD%207.34%20billion%20in%202025.), but ubiquity breeds sameness. As Sam Altman warns, we’ve entered a “[fast fashion era of SaaS](https://www.thedecisionstack.com/fast-fashion-saas-will-you-be-shein-hermes-or-history/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last),” where accessible tools create more copycats than differentiation. If anyone can plug into a recommendation API, the real question becomes: what makes advantage last when technical superiority is temporary?
...
Competitive edge now comes from how quickly you can execute, not how much data you own. [Des Traynor of Intercom](https://sacra.com/research/eoghan-mccabe-des-traynor-intercom-ai-customer-service/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) captures it well: *“You have to move with the uncertainty. AI is evolving too fast…you need to be willing to move on intuition.”* Intercom is betting on speed over certainty, going all-in on AI rather than waiting for perfect clarity.
...
![Road Block](https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,format=auto,onerror=redirect,quality=80/uploads/asset/file/ee025c77-6c64-4939-9f20-923f2fc4af43/photo-1530677003768-e25c2b121303.jpeg?t=1757258168)

[

Photo by Tim Collins on Unsplash

](https://unsplash.com/@timcollinsphoto?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last)
...
Their bet, which I walked through on [Friday last week](https://saielle.beehiiv.com/p/the-610m-browser-bet-how-atlassian-plans-to-own-the-future-of-work?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) shows how workflow intelligence and data flows are the bet over traditional data collection.
...
Amplify that value while building execution capabilities that compound over time. [Teresa Torres](https://www.producttalk.org/about/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) emphasises focusing on specific moments where insights directly influence customer outcomes rather than broad data collection strategies. Not all moats are equal.
...
What they shared was *sharper execution*: [faster algorithms](https://corporatefinanceinstitute.com/resources/management/first-mover-advantage/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last), cleaner interfaces, better customer experience, and operational focus where competitors lagged. Even in cloud computing, it wasn’t early adopters who defined the market, but the companies that scaled automation and reliability into everyday workflows. The pattern is clear: execution consistently outlasts incumbency.
...
[**The Browser Wars Are Over. The Platform Wars Have Begun**](https://www.platformer.news/ai-web-browsers-openai-perplexity-opera/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) **| Casey Newton**
...
**[Platform Engineering is Failing](https://thenewstack.io/platform-engineering-is-failing-heres-why-infrastructure-comes-first/?utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last)** **| Lukas Gentele**
...
![](https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,format=auto,onerror=redirect,quality=80/uploads/asset/file/95293dea-3127-4d80-9601-ac51f387fcc4/images.jpg?t=1756488021)
...
![](https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,format=auto,onerror=redirect,quality=80/uploads/asset/file/1453afa0-03e0-4bce-9475-ad8ba3d34359/untitled-92.png?t=1757096278)
...
I’m thrilled about [Brennan Lee Mulligan](https://www.instagram.com/brennanleemulligan/?hl=en&utm_source=newsletter.intentionaut.com&utm_medium=referral&utm_campaign=when-everyone-has-ai-building-execution-advantages-that-last) taking over as the GM for campaign four, and I could talk about that for hours, but it’s time for you to get back to other things.
